...
namespace Photon.Pun.UtilityScripts
{
    ...
    public static class ScoreExtensions
    {
        ...
        public static void AddScore(this Player player, int scoreToAddToCurrent , float y)
        {
            ...
            current = current + scoreToAddToCurrent * heightMultiplier;
            Debug.Log("New Score :" + current + " +" + scoreToAddToCurrent +" Height: "+y);
